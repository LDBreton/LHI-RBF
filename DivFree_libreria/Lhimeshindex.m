function [P_sc,P_fc,Indices_sup,distancepp] = Lhimeshindex(n_stencial_sc,meshfiles)


[ P_sc, P_fc ] = Read_ffmesh(meshfiles); %lee la malla de freemfem
